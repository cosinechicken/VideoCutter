...
parser.add_argument('--frame_quality', type=int, default=30, help="quality of frames to be extracted from input video. 1 is highest, 31 is lowest, 3 was the original default.")

args = parser.parse_args()

with open("C:\\Users\\brand\\Documents\\MIT_Course_Videos\\Lecture_Cutter_Cmd.txt", "a") as f:
    f.write("VolumeVisualizer (" + args.input_file + "): ")
...
# Path name: C:\Users\brand\TEMP_VISUALIZER
TEMP_FOLDER = "TEMP_VISUALIZER"
